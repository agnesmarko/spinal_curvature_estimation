...
def main():
    ...
    isl_validation_combined_ply_dir = project_root / 'isl_results' / 'silver' / f"isl_validation_combined_ply_{dataset_type}" / base_config.loss_function
    # or if the json files were generated using a fine-tuned model:
    # esl_validation_combined_ply_dir = project_root / 'esl_results' / 'transfer' / f"{transfer_config.transfer_strategy}" / f"isl_validation_combined_ply_{dataset_type}" / base_config.loss_function
    ...
    for json_file in os.listdir(json_files):
        ...
        combined_ply_path = isl_validation_combined_ply_dir
        create_combined_ply(
